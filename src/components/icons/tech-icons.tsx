...
export const MongoDBIcon = (props: IconProps) => ( // MongoDB logo
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="#47A248" {...props}>
    <path d="M50,0C22.4,0,0,22.4,0,50s22.4,50,50,50s50-22.4,50-50S77.6,0,50,0z M50,91.7c-23.2,0-41.7-18.5-41.7-41.7S26.8,8.3,50,8.3S91.7,26.8,91.7,50S73.2,91.7,50,91.7z M50,16.7c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S51.1,16.7,50,16.7z M50,24.2c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S51.1,24.2,50,24.2z M50,31.7c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S51.1,31.7,50,31.7z M50,39.2c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S51.1,39.2,50,39.2z M50,46.7c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S51.1,46.7,50,46.7z M50,54.2c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S51.1,54.2,50,54.2z M50,61.7c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S51.1,61.7,50,61.7z M50,69.2c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S51.1,69.2,50,69.2z"/>
  </svg>
);
